...
def getMinPosition(x, p1, p2):
	'''
	Returns the minimum values of the given array within the range p1

	:param x: The array to search for the min
	:param p1: The starting position for the range
	:param p2: The ending position for the range
	:return: the min
	'''
	return p1 + np.argmin(x[p1:p2])
...
ranges = Queue()
spaceRanger = np.linspace(0.0, 1.0, num=100)
